...
Partial Class mailbox
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Not Request.Form("name") Is Nothing Then
                ...
                Result = Mail(Request.Form("name"), Request.Form("phone"), Request.Form("txtmail"), Request.Form("service"), Request.Form("datepicker"), Request.Form("message"))
    ...
    'End Sub
    Private Shared Function Mail(ByVal name As String, ByVal phone As String, ByVal txtmail As String, ByVal service As String, ByVal adate As String, ByVal message As String) As String

        Dim Result As String = ""
        Dim templateVars As New Hashtable()
        templateVars.Add("Name", name.ToUpper())
        templateVars.Add("Mobile", phone)
        templateVars.Add("date", adate)
        templateVars.Add("Email", txtmail)
        templateVars.Add("Service", service)
        templateVars.Add("Message", message)
        'Result = Email.SendEmail("contact_email.htm", templateVars, "website@aspiretechnosys.com", "testingvb.net@gmail.com", "Website Enquiry GCA NDA Academy", "")
